...
$order['customFields']['delivery_date'] = $this->session->data['delivery_date'] ?? '';
$order['customFields']['delivery_time'] = $this->session->data['delivery_time'] ?? '';
$order['customFields']['need_call'] = $this->session->data['need_call'] ?? 0;
